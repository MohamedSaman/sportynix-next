...
export default function DownloadSection() {
  return (
    <div id="download" className="flex flex-col md:flex-row md:flex-nowrap items-center md:items-center md:justify-between gap-6 md:gap-8">
      {/* Store Buttons */}
      <div className="flex flex-col md:flex-row md:flex-nowrap items-center gap-3 md:gap-4">
        {/* App Store Button */}
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="inline-flex flex-shrink-0 items-center gap-3 px-6 py-3 rounded-xl bg-white/10 hover:bg-white/15 border border-white/20 transition-all group"
        >
